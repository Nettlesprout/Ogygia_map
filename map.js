...
function Map(config, deeds) {
	...
	this.load = function() {
		...
		for (var i = 0; i < this.deeds.length; i++) {
			...
			if ((this.mode == "3d" && this.config.showDeedBordersIn3dMode) || (this.mode == "flat" && this.config.showDeedBordersInFlatMode)) {
